...
let inhaleAudio = document.getElementById('inhaleAudio');
let exhaleAudio = document.getElementById('exhaleAudio');
let videoWidth;
let videoHeight;
let poseNet;
let pose;
...
let growDisplayIntervals = [2, 5, 10, 500, 10000];
let growDisplayCounter = 0;
let displayComponentIds = ['Console', 'Upgrades', 'Metrics', 'Leaderboard', 'Betting'];
let mandalaPlantCounter = 0;
...
let soundIds = [476590, 524813, 260871, 155140];
let upNext = 0;
let inhaleExhale = false;
let guidedBreathStart = 0;
let breathRateAverage = 3000;
let plantCounter = 1;
